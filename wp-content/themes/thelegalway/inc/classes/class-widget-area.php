...
if ( ! class_exists( 'Thelegalway_Widget_Area' ) ) {

	/**
	 * Class Thelegalway_Widget_Area.
	 */
	class Thelegalway_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'thelegalway_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'thelegalway_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'thelegalway_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function thelegalway_widget_area() {
		return Thelegalway_Widget_Area::get_instance();
	}

	thelegalway_widget_area();
}
