 ...
 */
add_filter( 'template_include', array( 'Thelegalway_Wrapping', 'wrap' ), 99 );
add_filter( 'thelegalway_wrap_base', 'thelegalway_wrap_base_cpts' );
 ...
 */
function thelegalway_template_path() {
	return Thelegalway_Wrapping::$main_template;
}
 ...
 */
function thelegalway_template_base() {
	return Thelegalway_Wrapping::$base;
}

if ( ! class_exists( 'Thelegalway_Wrapping' ) ) {
	...
	class Thelegalway_Wrapping {
		...
		/**
		 * Initialize new instance of Thelegalway_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'thelegalway_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Thelegalway_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new Thelegalway_Wrapping();
		}
	}
}
 ...
 */
function thelegalway_wrap_base_cpts( $templates ) {
