...
add_action( 'cherry_data_import_home_regex_replace', 'thelegalway_remap_shortcodes' );
add_action( 'cherry_data_import_remap_posts',        'thelegalway_remap_menus' );
add_action( 'cherry_data_import_remap_posts',        'thelegalway_remap_timetable' );
 ...
 * @return array
 */
function thelegalway_remap_shortcodes( $regex ) {
 ...
 */
function thelegalway_remap_timetable( $posts ) {
 ...
 * @param array $posts post remapping array.
 */
function thelegalway_remap_menus( $posts ) {
