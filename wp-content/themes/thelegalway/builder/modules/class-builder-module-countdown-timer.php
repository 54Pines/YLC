...
/**
 * Class Thelegalway_Builder_Module_Countdown_Timer.
 */
class Thelegalway_Builder_Module_Countdown_Timer extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Countdown Timer', 'thelegalway' );
		...
		$this->advanced_options = array(
			'fonts' => array(
				'header' => array(
					'label'    => esc_html__( 'Header', 'thelegalway' ),
					'css'      => array(
						'main' => "{$this->main_css_element} h4",
					),
				),
				'numbers' => array(
					'label'    => esc_html__( 'Numbers', 'thelegalway' ),
					'css'      => array(
				...
				'label' => array(
					'label'    => esc_html__( 'Label', 'thelegalway' ),
					'css'      => array(
		...
		$this->custom_css_options = array(
			'container' => array(
				'label'    => esc_html__( 'Container', 'thelegalway' ),
			...
			'timer_section' => array(
				'label'    => esc_html__( 'Timer Section', 'thelegalway' ),
				'selector' => '.section',
			),
		);
	}
	...
	public function get_fields() {
		$fields = array(
			'title' => array(
				'label'           => esc_html__( 'Countdown Timer Title', 'thelegalway' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'This is the title displayed for the countdown timer.', 'thelegalway' ),
			),
			'date_time' => array(
				'label'           => esc_html__( 'Countdown To', 'thelegalway' ),
				'type'            => 'date_picker',
				'option_category' => 'basic_option',
				'description'     => tm_get_safe_localization(
					sprintf(
						...
						esc_html__( 'This is the date the countdown timer is counting down to. Your countdown timer is based on your timezone settings in your ', 'thelegalway' ),
						esc_html__( 'WordPress General Settings', 'thelegalway' )
					)
				),
			),
			'use_background_color' => array(
				'label'           => esc_html__( 'Use Background Color', 'thelegalway' ),
				'type'            => 'yes_no_button',
				...
				'description' => esc_html__( 'Here you can choose whether background color setting below should be used or not.', 'thelegalway' ),
			),
			'background_color' => array(
				'label'             => esc_html__( 'Background Color', 'thelegalway' ),
				'type'              => 'color-alpha',
				'depends_default'   => true,
				'description'       => esc_html__( 'Here you can define a custom background color for your countdown timer.', 'thelegalway' ),
			),
			'timer_layout' => array(
				'label'             => esc_html__( 'Layout', 'thelegalway' ),
				'type'              => 'select',
				'options'           => array(
					'flat'   => esc_html__( 'Flat', 'thelegalway' ),
					'circle' => esc_html__( 'Circle', 'thelegalway' ),
				),
				'affects'           => array(
			...
			'circle_background' => array(
				'label'               => esc_html__( 'Circle Background Color', 'thelegalway' ),
				'type'                => 'color-alpha',
			...
			'use_circle_border' => array(
				'label'           => esc_html__( 'Use Circle Border', 'thelegalway' ),
				'type'            => 'yes_no_button',
...
new Thelegalway_Builder_Module_Countdown_Timer;
