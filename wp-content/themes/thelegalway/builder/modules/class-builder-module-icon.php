 ...
 */
class Thelegalway_Builder_Module_Icon extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Icon', 'thelegalway' );
		$this->icon = 'f1d8';
	...
	public function get_fields() {
		...
		$fields = array(
			'font_icon' => array(
				'label'               => esc_html__( 'Icon', 'thelegalway' ),
				'type'                => 'text',
				'option_category'     => 'basic_option',
				'class'               => array( 'tm-pb-font-icon' ),
				'renderer'            => 'tm_pb_get_font_icon_list',
				'renderer_with_field' => true,
				'description'         => esc_html__( 'Choose an icon to display.', 'thelegalway' ),
			),
			'icon_color' => array(
				'label'       => esc_html__( 'Icon Color', 'thelegalway' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for your icon.', 'thelegalway' ),
			),
			'use_circle' => array(
				'label'           => esc_html__( 'Circle Icon', 'thelegalway' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'off' => esc_html__( 'No', 'thelegalway' ),
					'on'  => esc_html__( 'Yes', 'thelegalway' ),
				),
				'affects'         => array(
				...
				'description'     => esc_html__( 'Here you can choose whether icon set above should display within a circle.', 'thelegalway' ),
			),
			'circle_color' => array(
				'label'       => esc_html__( 'Circle Color', 'thelegalway' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle.', 'thelegalway' ),
			),
			'use_circle_border' => array(
				'label'           => esc_html__( 'Show Circle Border', 'thelegalway' ),
				'type'            => 'yes_no_button',
				...
				'description'     => esc_html__( 'Here you can choose whether if the icon circle border should display.', 'thelegalway' ),
			),
			'circle_border_color' => array(
				'label'       => esc_html__( 'Circle Border Color', 'thelegalway' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle border.', 'thelegalway' ),
			),
			'animation' => array(
				'label'           => esc_html__( 'Icon Animation', 'thelegalway' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'top'    => esc_html__( 'Top To Bottom', 'thelegalway' ),
					'left'   => esc_html__( 'Left To Right', 'thelegalway' ),
					'right'  => esc_html__( 'Right To Left', 'thelegalway' ),
					'bottom' => esc_html__( 'Bottom To Top', 'thelegalway' ),
					'off'    => esc_html__( 'No Animation', 'thelegalway' ),
				),
				'description'     => esc_html__( 'This controls the direction of the lazy-loading animation.', 'thelegalway' ),
			),
			'icon_orientation' => array(
				'label'           => esc_html__( 'Icon Orientation', 'thelegalway' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => array(
				...
				'description'     => esc_html__( 'This will control how your icon is aligned.', 'thelegalway' ),
			),
			'use_icon_font_size' => array(
				'label'           => esc_html__( 'Use Icon Font Size', 'thelegalway' ),
				'type'            => 'yes_no_button',
			...
			'icon_font_size' => array(
				'label'           => esc_html__( 'Icon Font Size', 'thelegalway' ),
				'type'            => 'range',
				'option_category' => 'font_option',
				'tab_slug'        => 'advanced',
				'default'         => '50px',
			...
			'circle_size' => array(
				'label'           => esc_html__( 'Circle Size', 'thelegalway' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'default'         => '100',
				...
				'description'     => esc_html__( 'Here you can define a custom diameter for the icon circle.', 'thelegalway' ),
				'mobile_options'  => true,
				'depends_default' => true,
			),
			'circle_border_width' => array(
				'label'           => esc_html__( 'Circle Border Width', 'thelegalway' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'default'         => '2',
				...
				'description'     => esc_html__( 'Here you can define a custom width for the icon circle border.', 'thelegalway' ),
				'depends_default' => true,
			),
			...
			'disabled_on' => array(
				'label'           => esc_html__( 'Disable on', 'thelegalway' ),
				'type'            => 'multiple_checkboxes',
				'options'         => tm_pb_media_breakpoints(),
				'additional_att'  => 'disable_on',
				'option_category' => 'configuration',
				'description'     => esc_html__( 'This will disable the module on selected devices', 'thelegalway' ),
			),
			'admin_label' => array(
				'label'       => esc_html__( 'Admin Label', 'thelegalway' ),
				'type'        => 'text',
				'description' => esc_html__( 'This will change the label of the module in the builder for easy identification.', 'thelegalway' ),
			),
			'module_id' => array(
				'label'           => esc_html__( 'CSS ID', 'thelegalway' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
			...
			'module_class' => array(
				'label'           => esc_html__( 'CSS Class', 'thelegalway' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
				'option_class'    => 'tm_pb_custom_css_regular',
...
new Thelegalway_Builder_Module_Icon;
